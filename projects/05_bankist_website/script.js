...
//using callback function to pass the argument to the handler
...
//using bind method to pass the argument to the handler
...
// const header = document.querySelector('.header'); // already selected at the top
